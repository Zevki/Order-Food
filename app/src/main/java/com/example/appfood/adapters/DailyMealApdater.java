...
import com.example.appfood.activities.DetailDaily;
import com.example.appfood.models.DailyMealModel;

import java.util.List;

public class DailyMealApdater extends RecyclerView.Adapter<DailyMealApdater.ViewHolder> {

    Context context;
    List<DailyMealModel> list;

    public DailyMealApdater(Context context, List<DailyMealModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetailDaily.class);
